...
inline      __m256d  fast_inv_Phi_approx_wo_checks_AVX2 VECTORCALL(const __m256d x )  {
      ...
      ALIGN32  __m256d const  inv_Phi_approx_c1 = _mm256_set1_pd(-0.34176618822627863);
      ALIGN32  __m256d const  inv_Phi_approx_c2 = _mm256_set1_pd(2.7472242570765295);
      ...
      ALIGN32  __m256d const  x_i =  _mm256_mul_pd(m_logit_p, inv_Phi_approx_c1) ; // -0.34176618822627863*m_logit_p;
...
inline     __m256d  fast_inv_Phi_approx_AVX2 VECTORCALL(const __m256d x )  {
      ...
      ALIGN32  __m256d const x_i =  _mm256_mul_pd(m_logit_p, _mm256_set1_pd(-0.34176618822627863)) ; // -0.34176618822627863*m_logit_p;
      ...
      ALIGN32  __m256d const res = _mm256_mul_pd(  _mm256_set1_pd(2.7472242570765295),   _mm256_div_pd( _mm256_sub_pd(_mm256_mul_pd(exp_x_i, exp_x_i),  _mm256_set1_pd(1.0)), exp_x_i) ) ;    //   now do sinh parth part
      return res;
...
ALWAYS_INLINE __m256d fast_Phi_wo_checks_AVX2 VECTORCALL(const __m256d x) {
       ...
       ALIGN32  __m256d const z_rational = _mm256_min_pd(z, _mm256_set1_pd(FAST_PHI_MILLS_Z_CAP));

       ALIGN32  __m256d numerator = _mm256_set1_pd(FAST_PHI_MILLS_NUMERATOR_COEFFICIENTS[6]);
       numerator = _mm256_fmadd_pd(numerator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_NUMERATOR_COEFFICIENTS[5]));
       numerator = _mm256_fmadd_pd(numerator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_NUMERATOR_COEFFICIENTS[4]));
       numerator = _mm256_fmadd_pd(numerator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_NUMERATOR_COEFFICIENTS[3]));
       numerator = _mm256_fmadd_pd(numerator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_NUMERATOR_COEFFICIENTS[2]));
       numerator = _mm256_fmadd_pd(numerator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_NUMERATOR_COEFFICIENTS[1]));
       numerator = _mm256_fmadd_pd(numerator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_NUMERATOR_COEFFICIENTS[0]));

       ALIGN32  __m256d denominator = _mm256_set1_pd(FAST_PHI_MILLS_DENOMINATOR_COEFFICIENTS[7]);
       denominator = _mm256_fmadd_pd(denominator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_DENOMINATOR_COEFFICIENTS[6]));
       denominator = _mm256_fmadd_pd(denominator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_DENOMINATOR_COEFFICIENTS[5]));
       denominator = _mm256_fmadd_pd(denominator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_DENOMINATOR_COEFFICIENTS[4]));
       denominator = _mm256_fmadd_pd(denominator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_DENOMINATOR_COEFFICIENTS[3]));
       denominator = _mm256_fmadd_pd(denominator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_DENOMINATOR_COEFFICIENTS[2]));
       denominator = _mm256_fmadd_pd(denominator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_DENOMINATOR_COEFFICIENTS[1]));
       denominator = _mm256_fmadd_pd(denominator, z_rational, _mm256_set1_pd(FAST_PHI_MILLS_DENOMINATOR_COEFFICIENTS[0]));
       ...
       ALIGN32  __m256d const val = _mm256_mul_pd(exp_stuff, _mm256_div_pd(numerator, denominator));   //// Phi(-z) = exp(-z^2/2) * N(z) / Q(z)
