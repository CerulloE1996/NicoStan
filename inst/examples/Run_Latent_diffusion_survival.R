...
## The 0.01 hazard offset and the normal(1.4, 1) / normal(1, 1) drift priors are changes (not in Beskos et al.)
## that remove the divergences; see MODEL_NOTES.md and the .stan header.
