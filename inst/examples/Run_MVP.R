#### =====================================================================================================================================
## MVP: native manual-gradient example from the BayesMVP extension.
...
native_benchmark <-  benchmark_BayesMVP_native_example(Model_type = "MVP", N_values = N_values, burnin_algorithm = "CHESSR")
