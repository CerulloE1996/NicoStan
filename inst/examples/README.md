...
- **Benchmark functions:** `NicoStan_examples.R` runs an individual arm; `NicoStan_benchmarks.R` runs the three sample sizes and compares CmdStanR, NicoStan and NicoStan with AVX-512. AVX2 is available on supported CPUs.
