...
inline  std::vector<Rcpp::NumericMatrix> vec_of_mats_Rcpp(int n_rows, 
                                                                 int n_cols, 
                                                                 int n_matrices) {
...
inline  int flatten_index(int i,
                                 int j, 
                                 int dim1) {
...
inline std::vector<Rcpp::NumericMatrix> create_3D_array_as_vector_of_2D_matrices(const Rcpp::NumericMatrix& array_2D,
                                                                          const int dim1,
                                                                          const int dim2,
                                                                          const int dim3) {
